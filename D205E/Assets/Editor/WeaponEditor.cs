...
public class WeaponEditorWindow : EditorWindow
{
    ...
    void OnGUI()
    {
        ...
        if (GUILayout.Button("Save"))
        {
            ...
            ItemManager.Instance.SaveChanges(DatabaseFile);

            (EditorWindow.GetWindow(typeof(WeaponListWindow)) as WeaponListWindow).RefreshList();
...
public class WeaponListWindow : EditorWindow
{
    ...
    {
        DatabaseFile = Application.streamingAssetsPath + "/Data/Items.bytes";
        ItemManager.Instance.FileName = DatabaseFile;
